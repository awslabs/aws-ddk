...
>>>>>>> 144f801 (add glue transform stage & simple test case)
...
=======
### GlueTransformStage <a name="GlueTransformStage" id="aws-ddk-dev.GlueTransformStage"></a>

#### Initializers <a name="Initializers" id="aws-ddk-dev.GlueTransformStage.Initializer"></a>

```typescript
import { GlueTransformStage } from 'aws-ddk-dev'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#aws-ddk-dev.GlueTransformStage.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStage.Initializer.parameter.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStage.Initializer.parameter.props">props</a></code> | <code><a href="#aws-ddk-dev.GlueTransformStageProps">GlueTransformStageProps</a></code> | *No description.* |

---

##### `scope`<sup>Required</sup> <a name="scope" id="aws-ddk-dev.GlueTransformStage.Initializer.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `id`<sup>Required</sup> <a name="id" id="aws-ddk-dev.GlueTransformStage.Initializer.parameter.id"></a>

- *Type:* string

---

##### `props`<sup>Required</sup> <a name="props" id="aws-ddk-dev.GlueTransformStage.Initializer.parameter.props"></a>

- *Type:* <a href="#aws-ddk-dev.GlueTransformStageProps">GlueTransformStageProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#aws-ddk-dev.GlueTransformStage.toString">toString</a></code> | Returns a string representation of this construct. |
| <code><a href="#aws-ddk-dev.GlueTransformStage.addAlarm">addAlarm</a></code> | *No description.* |

---

##### `toString` <a name="toString" id="aws-ddk-dev.GlueTransformStage.toString"></a>
...
##### `addAlarm` <a name="addAlarm" id="aws-ddk-dev.GlueTransformStage.addAlarm"></a>

```typescript
public addAlarm(id: string, props: AlarmProps): DataStage
```

###### `id`<sup>Required</sup> <a name="id" id="aws-ddk-dev.GlueTransformStage.addAlarm.parameter.id"></a>

- *Type:* string

---

###### `props`<sup>Required</sup> <a name="props" id="aws-ddk-dev.GlueTransformStage.addAlarm.parameter.props"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#aws-ddk-dev.GlueTransformStage.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### ~~`isConstruct`~~ <a name="isConstruct" id="aws-ddk-dev.GlueTransformStage.isConstruct"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="aws-ddk-dev.GlueTransformStage.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#aws-ddk-dev.GlueTransformStage.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#aws-ddk-dev.GlueTransformStage.property.description">description</a></code> | <code>string</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStage.property.eventPattern">eventPattern</a></code> | <code>aws-cdk-lib.aws_events.EventPattern</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStage.property.name">name</a></code> | <code>string</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStage.property.targets">targets</a></code> | <code>aws-cdk-lib.aws_events.IRuleTarget[]</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStage.property.cloudwatchAlarms">cloudwatchAlarms</a></code> | <code>aws-cdk-lib.aws_cloudwatch.Alarm[]</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStage.property.stateMachine">stateMachine</a></code> | <code>aws-cdk-lib.aws_stepfunctions.StateMachine</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStage.property.stateMachineInput">stateMachineInput</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |

---

##### `node`<sup>Required</sup> <a name="node" id="aws-ddk-dev.GlueTransformStage.property.node"></a>
...
##### `description`<sup>Optional</sup> <a name="description" id="aws-ddk-dev.GlueTransformStage.property.description"></a>
...
##### `eventPattern`<sup>Optional</sup> <a name="eventPattern" id="aws-ddk-dev.GlueTransformStage.property.eventPattern"></a>
...
##### `name`<sup>Optional</sup> <a name="name" id="aws-ddk-dev.GlueTransformStage.property.name"></a>
...
##### `targets`<sup>Optional</sup> <a name="targets" id="aws-ddk-dev.GlueTransformStage.property.targets"></a>
...
##### `cloudwatchAlarms`<sup>Required</sup> <a name="cloudwatchAlarms" id="aws-ddk-dev.GlueTransformStage.property.cloudwatchAlarms"></a>
...
##### `stateMachine`<sup>Required</sup> <a name="stateMachine" id="aws-ddk-dev.GlueTransformStage.property.stateMachine"></a>
...
##### `stateMachineInput`<sup>Required</sup> <a name="stateMachineInput" id="aws-ddk-dev.GlueTransformStage.property.stateMachineInput"></a>
...
=======
### GlueTransformStageProps <a name="GlueTransformStageProps" id="aws-ddk-dev.GlueTransformStageProps"></a>

#### Initializer <a name="Initializer" id="aws-ddk-dev.GlueTransformStageProps.Initializer"></a>

```typescript
import { GlueTransformStageProps } from 'aws-ddk-dev'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#aws-ddk-dev.GlueTransformStageProps.property.description">description</a></code> | <code>string</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStageProps.property.name">name</a></code> | <code>string</code> | *No description.* |
| <code><a href="#aws-ddk-dev.GlueTransformStageProps.property.additionalRolePolicyStatements">additionalRolePolicyStatements</a></code> | <code>aws-cdk-lib.aws_iam.PolicyStatement[]</code> | *No description.* |
...
##### `description`<sup>Optional</sup> <a name="description" id="aws-ddk-dev.GlueTransformStageProps.property.description"></a>
...
##### `name`<sup>Optional</sup> <a name="name" id="aws-ddk-dev.GlueTransformStageProps.property.name"></a>
...
##### `additionalRolePolicyStatements`<sup>Optional</sup> <a name="additionalRolePolicyStatements" id="aws-ddk-dev.GlueTransformStageProps.property.additionalRolePolicyStatements"></a>
...
##### `stateMachineFailedExecutionsAlarmEvaluationPeriods`<sup>Optional</sup> <a name="stateMachineFailedExecutionsAlarmEvaluationPeriods" id="aws-ddk-dev.GlueTransformStageProps.property.stateMachineFailedExecutionsAlarmEvaluationPeriods"></a>
...
##### `stateMachineFailedExecutionsAlarmThreshold`<sup>Optional</sup> <a name="stateMachineFailedExecutionsAlarmThreshold" id="aws-ddk-dev.GlueTransformStageProps.property.stateMachineFailedExecutionsAlarmThreshold"></a>
...
##### `stateMachineInput`<sup>Optional</sup> <a name="stateMachineInput" id="aws-ddk-dev.GlueTransformStageProps.property.stateMachineInput"></a>
...
##### `jobArgs`<sup>Optional</sup> <a name="jobArgs" id="aws-ddk-dev.GlueTransformStageProps.property.jobArgs"></a>
